...
<body>
	<!-- Page Container -->
    <!-- <div id="page-container" class="sidebar-l sidebar-mini sidebar-o side-scroll header-navbar-fixed"> --><!-- default hide -->
    <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed"><!-- default show -->
		<!-- Sidebar -->
		<nav id="sidebar">
