...
//
// import com.smt.model.Student;
// import com.smt.util.HibernateUtil;
//
/// **
...
//
// AppDemo application = new AppDemo();
//
// /*
...
// List<Student> employees = (List<Student>) session.createQuery("FROM Student s
// ORDER BY s.firstName ASC").list();
//
// session.getTransaction().commit();
// session.close();
// return employees;
